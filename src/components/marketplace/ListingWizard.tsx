            ...
            {step === 1 && (
              <div className="space-y-4">
                ...
                {formData.subCategory && (
                  <div>
                    <label className="block text-sm font-medium mb-1">Specific Type</label>
                    <select
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full p-2 border rounded-lg min-h-[120px] focus:ring-2 focus:ring-primary-500"
